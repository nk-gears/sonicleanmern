            ...
            <>
              <Row className="mb-4">
                ...
                <Col sm="4">
                  ...
                  <div>
                    Order <strong>#: {orderDataById.cust_ref}</strong>
                  </div>
                  <div>
                    Order Type:
                    <strong>
                      {' '}
                      {orderDataById.cust_ref &&
                      orderDataById.cust_ref.split('.')[1] === 'DS'
                        ? 'Direct Ship'
                        : 'Inventory'}
                    </strong>
                  </div>
                    ...
                    orderDataById.items.map((item, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td className="left">
                            <strong>{getProductName(item.item)}</strong>
                          </td>
