            ...
            <Row>
              <Col className="RegisterSubmitModal">
                {state === REQUEST_STATUS.SUCCESS && (
                  <>
                    <h5>
                      ...
                      successfully submitted. Please allow up to 24 to 48 hours
                      for account approval. Once your account is approved, you
                      will receive an activation email with your login
                      credentials. If you have any questions, you can contact
                      Soniclean's dealer department. <br />
                    </h5>
                    <br />
                ...
                {state === REQUEST_STATUS.FAIL && (
                  <h5>
                    Unfortunately, we are having trouble processing your dealer
                    registration. For further assistance, please contact
                    Soniclean's dealer support department.
                  </h5>
                )}
                <h5 className="font-weight-bold mt-4">Phone: (954) 228-9100</h5>
                <h5 className="font-weight-bold mt-2">
                  Email: dealers@sonicleanusa.com
                </h5>
              </Col>
            </Row>
          }
