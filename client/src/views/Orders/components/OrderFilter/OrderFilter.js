...
const OrderFilter = ({
    ...
    const handleOrderTypeChange = (event) => {
        ...
        if(moment(startDate).isSame(moment(endDate))) {
            ...
            changeFilterOptions(event.target.value, oderStatus, moment(startDate), moment(endDate))
        }
    ...
    const handleOrderStatusChange = (event) => {
        ...
        if(moment(startDate).isSame(moment(endDate))) {
            ...
            changeFilterOptions(orderType, event.target.value, moment(startDate), moment(endDate))
        }
    }
    ...
    const handleChangeDate = (startDate, endDate) => {
        ...
        if(startDate!==null && endDate!==null) {
            changeFilterOptions(orderType, oderStatus, moment(startDate), moment(endDate))
        }
    }
    ...
    return (
        <Row className="orderfilter">
            <Col className="d-flex align-items-center justify-content-center" xs={3}>
                <Label for="ccmonth" className="mr-2 mb-0 text-right">Order type: </Label>
                <Input type="select" name="ccmonth" id="ccmonth" onChange={handleOrderTypeChange} value={orderType} >
            ...
            <Col className="d-flex align-items-center justify-content-center" xs={4}>
                ...
                <Input type="select" name="ccmonth" id="ccmonth" onChange={handleOrderStatusChange}>
                        <option value="ALL" defaultValue>All</option>
            ...
            <Col className="d-flex align-items-center justify-content-center" xs={5}>
                ...
                <DateRangePicker
                    ...
                    isOutsideRange={() => null}
                    endDateId="endDate"
                    onDatesChange={({startDate, endDate}) => handleChangeDate(startDate, endDate)}
