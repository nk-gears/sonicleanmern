  ...
  const getCardType = (param) => {
    ...
    return (
      <div className="PaymentMethod mt-2">
          ...
          <CardBody className={classNames('PaymentMethod__card align-items-center text-black ', selectedIndex === data._id ? 'PaymentMethod__selected': '')}>
                <Row className="align-items-center">
                  <Col sm={12} md={3} ><img src={getCardType(data.cardtype)} alt="visa" /></Col>
                  <Col sm={12} md={3} >
              ...
              <Col sm={12} md={6} className="text-md-center text-sm-left" >
                <AppSwitch className={'mx-1 mt-2'} color={'success'} checked={selectedIndex=== data._id } disabled label dataOn={'selected'} dataOff={'select'} />
                  </Col>
                </Row>
              </CardBody>
            </Card>
